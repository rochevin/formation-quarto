...
```{=html}
<iframe
  src="first_quarto_file/first_quarto_document.html"
  width="100%"
  height="600"
...
```bash
quarto render first_quarto_file/first_quarto_document.qmd
...
````
{{< include first_quarto_file/first_quarto_document.qmd >}}
````
